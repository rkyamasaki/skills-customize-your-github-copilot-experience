...
- **Utilizar sempre Conventional Commits**: Todas as mensagens de commit devem seguir o padrão [Conventional Commits](https://www.conventionalcommits.org/pt-br/v1.0.0/), facilitando o entendimento do histórico e automação de processos.
